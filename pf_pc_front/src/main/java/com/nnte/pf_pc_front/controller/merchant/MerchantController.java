...
public class MerchantController extends BaseController {
     ...
     * 显示商户申请列表Index页面
     * */
    @ModuleEnter(path = "/merchant/merchantApply/index", name="商户申请管理", desc = "平台商户申请管理，业务管理员功能",
            sysRole = PfBusinessComponent.PLATEFORM_MERCAHNT_WORKER,roleRuler = "pf-merchant-worker",
            appCode = PcPlateformApplication.App_Code,moduleCode = PcPlateformApplication.MODULE_MERCHANT_MANAGE)
    @RequestMapping(value = "/merchantApply/index")
    public ModelAndView index(HttpServletRequest request, ModelAndView modelAndView){
        ...
        modelAndView.setViewName("front/merchant/apply/index");
        return modelAndView;
    }
    /**
     * 邮件验证
     * */
    @RequestMapping(value = "/merchantApply/applyVerify")
     ...
     * 返回商户申请列表数据
     * */
    @RequestMapping(value = "/merchantApply/list")
    public void list(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            Map<String, Object> loadMap = plateformMerchanApplyComponent.queryApplyList(dto, oi);
     ...
     * 保存商户申请信息
     * */
    @RequestMapping(value = "/merchantApply/saveApplyModify")
    @ResponseBody
     ...
     * 通过编码查询特定操作员信息
     * */
    @RequestMapping(value = "/merchantApply/queryMerchantApply")
    @ResponseBody
     ...
     * 发送商户申请的验证邮件
     * */
    @RequestMapping(value = "/merchantApply/sendApplyVerifyEmail")
    @ResponseBody
     ...
     * 发送商户申请的验证短信
     * */
    @RequestMapping(value = "/merchantApply/sendApplyVerifySM")
    @ResponseBody
