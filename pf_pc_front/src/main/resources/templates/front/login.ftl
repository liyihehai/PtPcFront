...
<form action="/pfPcFront/main/loginCheck" name="loginForm" id="loginForm_id" method="post">
    ...
    <div class="container main-cont">
      ...
      <div class="banner-form">
        <div class="form">
          ...
          <ul class="form-ul">
            <li><input class="input-wp" maxlength="20" type="tel" placeholder="请输入手机号或账号" name="userName" id="userName" value="<#if m_pc_cookie?exists>${m_pc_cookie}</#if>">
            ...
            <li class="form-radio clearfix" onClick="submit_me();">
              <input type="checkbox" <#if m_pc_cookie?exists>checked="checked"</#if> name="isRemember" value="1"><span>记住我</span>
